										...
										<div className="grid grid-cols-2 gap-3">
											<div className="space-y-1">
												...
												<Select
													...
													onValueChange={(v) =>
														updatePublishField("category", v as StoreCategory)
													}
												>
													<SelectTrigger>
											...
											<div className="space-y-1">
												...
												<Select
													...
													onValueChange={(v) =>
														updatePublishField("pricingType", v as PricingType)
													}
												>
													<SelectTrigger>
													...
													<SelectContent>
														<SelectItem value={PricingType.FREE}>
															免费
														</SelectItem>
														<SelectItem value={PricingType.ONETIME}>
															一次性买断
														</SelectItem>
														<SelectItem value={PricingType.SUBSCRIPTION}>
															订阅
														</SelectItem>
														<SelectItem value={PricingType.USAGE}>
															按量计费
														</SelectItem>
													</SelectContent>
												</Select>
