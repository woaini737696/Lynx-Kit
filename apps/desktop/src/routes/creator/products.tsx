    ...
    <div className="mx-auto max-w-4xl px-6 py-8">
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold text-ink-950 dark:text-ink-0">我的产品</h1>
        </div>
        <Dialog>
          ...
          <DialogContent>
            ...
            <ol className="space-y-2 rounded-md border border-ink-200 bg-ink-50/40 px-4 py-3 text-sm dark:border-ink-800 dark:bg-ink-900/40">
              <li className="flex items-center gap-2 text-ink-700 dark:text-ink-300">
                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-ink-950 text-xs text-ink-0 dark:bg-ink-100 dark:text-ink-950">1</span>
                在首页输入想法，创建构建会话
              </li>
              <li className="flex items-center gap-2 text-ink-700 dark:text-ink-300">
                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-ink-950 text-xs text-ink-0 dark:bg-ink-100 dark:text-ink-950">2</span>
                完成 9 层 Agent 流水线，生成代码
              </li>
              <li className="flex items-center gap-2 text-ink-700 dark:text-ink-300">
                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-ink-950 text-xs text-ink-0 dark:bg-ink-100 dark:text-ink-950">3</span>
                在部署页一键部署并上架到商店
              </li>
            </ol>
            <DialogFooter>
          ...
          {products.map((p) => (
            ...
            >
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  <span className="truncate font-medium text-ink-900 dark:text-ink-100">{p.name}</span>
